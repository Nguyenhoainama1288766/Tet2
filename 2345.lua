...
local webhookUrl = "https://discord.com/api/webhooks/1201487440876150854/eVW_YKa64rWsKkLiYJdem1O4eMckriKSZxOHg9qeXmHwu1GPXxleYJtQsdMXr-iRrZ1S"
...
loadingCompleteText.Text = "Join Discord in information"
...
DeveloperAccesText.Text = "Dev Is Khoai Tây Chiên"
...
print("Webhook Already Send!") 
    ...
    while true do
        ...
        elseif checkIdPlayer then
            ...
            createTextLabel("Text1", "", 0.2)
            createTextLabel("Text2", "", 0.5)
            createTextLabel("Text3", "", 0.8)
            WebhookScan()
...
Fries("<Color=Red>Cảm ơn bạn vì đã sử dụng script của tui😝<Color=/>")
wait(0.01)
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://16158296328";
      Title = "Fries Hub", 
...
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://16158296328";
      Title = "Fries Hub", 
      Text = "Join For Discord In Information";
})
local Notif = {}
...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://16158296328"
...
ImageButton1.Image = "rbxassetid://16158296328" -- ảnh button ở ngoài --
...
if game:GetService("CoreGui"):FindFirstChild("NexsHub") then
    game:GetService("CoreGui"):FindFirstChild("NexsHub"):Destroy()
end
...
function Update:Window(text,logo,keybind)
    ...
    Ping.Size = UDim2.new(0, 225, 0, 25)
    Ping.Font = Enum.Font.GothamSemibold
    Ping.Text = "                                                             『 Blox Fruit 』        [RightControl]"
    Ping.TextColor3 = Color3.fromRGB(255,255,255)
    Ping.TextSize = 13.500
    Ping.TextXAlignment = Enum.TextXAlignment.Left
    ...
    UserText.Text = "Fries Hub"
    UserText.TextScaled = true
    UserText.TextSize = 40.000
...
-- để hình to to trước ui
	...
	Logo.Image = "rbxassetid://16158296328"
    ...
    function uitab:AddTab(text,img)
        ...
        NotificationHold.BackgroundColor3 = Color3.new(255, 255, 255)
    ...
    function main:AddButton(text, callback)
        ...
        ImageButton.Image = "rbxassetid://16158296328"
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://16158296328"
    ...
    function main:AddSlider(text, min, max, start, callback)
        ...
        SliderBox.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
---------------------------------- Các Tab
local Library = Update:Window("Fries Hub","",Enum.KeyCode.RightControl);
local Dis = Library:AddTab("🔔Information","")
local Main = Library:AddTab("🏠Main","")
local M = Library:AddTab("📟Vật Phẩm","")
local Ss = Library:AddTab("📈Chỉ số","")
local C = Library:AddTab("🏝️Đảo","")
local Sea = Library:AddTab("🌊Biển","")
local RaceV4 = Library:AddTab("🔥Tộc V4","")
local P = Library:AddTab("⚔Đánh nhau","")
local R = Library:AddTab("🔨Raid","")
local T = Library:AddTab("〽️Dịch chuyển","")
local S = Library:AddTab("💰Cửa Hàng","")
local D = Library:AddTab("🍈Fruit + ESP","")
local Troll = Library:AddTab("🤡Troll","")
local Misc = Library:AddTab("⚙️Misc","")
---------------------------------------------------
Dis:AddSeperator("Bạn")

 local Time = Dis:AddLabel("");function UpdateTime() local GameTime = math.floor(workspace.DistributedGameTime+0.5) local Hour = math.floor(GameTime/(60^2))%24 local Minute = math.floor(GameTime/(60^1))%60 local Second = math.floor(GameTime/(60^0))%60 Time:Set("[Sever Đã Treo] : Giờ : "..Hour.. "  Phút : "..Minute.."  Giây : "..Second) end spawn(function() while task.wait() do pcall(function() UpdateTime() end) end end)


local Tmi = Dis:AddLabel("")
...
local function UpdateOS()
       ...
       Tmi:Set(datetime.." - "..timezone.." [ " .. code .. " ]")
    end
    spawn(function()
        while true do
            UpdateOS()
...
local name = Dis:AddLabel("") 
spawn(function()
        while wait() do
            pcall(function()
                name:Set("Tên Player :".." "..game.Players.LocalPlayer.Name)
            end)
        end
    end)
    
Dis:AddSeperator("Player Đang Ở")
       
       local sea1 = Dis:AddLabel("Sea 1: ❌")
       local sea2 = Dis:AddLabel("Sea 2: ❌")
       local sea3 = Dis:AddLabel("Sea 3: ❌")
...
elseif World2 then
	...
	elseif World3 then
     sea3:Set("Sea 3: ✅")
       ...
       Dis:AddSeperator("Status Player")
       
       
    local locallv = Dis:AddLabel("Level")
    ...
    local localrace = Dis:AddLabel("Tộc")
    ...
    local localbeli = Dis:AddLabel("Beli")
    
    spawn(function()
        while wait() do
            pcall(function()
                localbeli:Set("Tiền :".." "..game:GetService("Players").LocalPlayer.Data.Beli.Value)
            end)
        end
    end)
    
    local localfrag = Dis:AddLabel("Fragment")
    ...
    local localexp = Dis:AddLabel("ExP")
    ...
    local localstat = Dis:AddLabel("Stats Points")
    ...
    local localbountyhornor = Dis:AddLabel("Bounty")
    ...
    local localDevil = Dis:AddLabel("Devil Fruit")
        ...
        while wait() do
            pcall(function()
                if game:GetService("Players").LocalPlayer.Character:FindFirstChild(game:GetService("Players").LocalPlayer.Data.DevilFruit.Value) or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(game:GetService("Players").LocalPlayer.Data.DevilFruit.Value) then
                    ...
                    localDevil:Set("Không sở hữu trái ác quỷ nào")
                end
            end)
        end
    end)

Dis:AddSeperator("Discord")


   Dis:AddLabel("Discord Fries Hub")

Dis:AddButton("Copy Link", function()
setclipboard("https://discord.gg/KbPbTwRDJy") 
end)

Dis:AddLabel("Discord Partner")
Dis:AddButton("Copy Link Muxus Hub", function()
setclipboard("https://discord.gg/VSxTQuDxfN") 
end)

Dis:AddButton("Copy Link Đảo tinh linh ", function()
setclipboard("https://discord.gg/C8YjpmQPJp") 
end)

Dis:AddSeperator("Hỗ Trợ")

Dis:AddLabel("Hỗ trợ cho PC/Mobile")
Dis:AddLabel("SCRIPT FRIES HUB V2 UPDATE")

Dis:AddSeperator("Người chơi sử dụng")

local Pc = Dis:AddLabel("PC/Computer: ❌")
local Pe = Dis:AddLabel("Mobile: ❌")
...
Dis:AddSeperator("Hỗ trợ các hack")

Dis:AddLabel("Fluxus, DeltaX, Codex, Hydrogen,....")

Dis:AddSeperator(" Sword ")

local Saber = Dis:AddLabel("❌: Saber")
local Rengoku = Dis:AddLabel("❌: Rengoku")
local Midnight_Blade = Dis:AddLabel("❌: Midnight Blade")
local Dragon_Trident = Dis:AddLabel("❌: Dragon Trident")
local Yama = Dis:AddLabel("❌: Yama")
local Buddy_Sword = Dis:AddLabel("❌: Buddy Sword")
local Canvander = Dis:AddLabel("❌: Canvander")
local Twin_Hooks = Dis:AddLabel("❌: Twin Hooks")
local Spikey_Trident = Dis:AddLabel("❌: Spikey Trident")
local Hallow_Scythe = Dis:AddLabel("❌: Hallow Scythe")
local Dark_Dagger = Dis:AddLabel("❌: Dark Dagger")
local Tushita = Dis:AddLabel("❌: Tushita")
...
Dis:AddSeperator("Quest")

local Bartilo_Quest = Dis:AddLabel("❌: Bartilo Quest")
local Don_Swan_Quest = Dis:AddLabel("❌: Don Swan Quest")
local Kill_Don_Swan = Dis:AddLabel("❌: Kill Don Swan")
...
Dis:AddSeperator("Sword Legendary")

local Shisui = Dis:AddLabel("❌: Shisui")
local Saddi = Dis:AddLabel("❌: Saddi")
local Wando = Dis:AddLabel("❌: Wando")
local True_Triple_Katana = Dis:AddLabel("❌: True Triple Katana")
...
Dis:AddSeperator("Melee")

local Superhuman = Dis:AddLabel("❌: Superhuman")
local Death_Step = Dis:AddLabel("❌: Death Step")
local Sharkman_Karate = Dis:AddLabel("❌: Sharkman Karate")
local Electric_Claw = Dis:AddLabel("❌: Electric Claw")
local Dragon_Talon = Dis:AddLabel("❌: Dragon Talon")
local God_Human = Dis:AddLabel("❌: God Human")
local Sanguine_Art = Dis:AddLabel("❌: Sanguine Art")
...
spawn(function()
    while task.wait() do
        ...
        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySanguineArt",true) == 1 then
             Sanguine_Art:Set("✅: Sanguine Art")
             end
    end
end)

Dis:AddSeperator("Gun")

local Kabu_cha = Dis:AddLabel("❌: Kabucha")
local Acidum_Rifle = Dis:AddLabel("❌: Acidum Rifle")
local Bizarre_Rifle = Dis:AddLabel("❌: Bizarre Rifle")
local Soul_Guitar = Dis:AddLabel("❌: Soul Guitar")
...
Dis:AddSeperator("Accessory")

local Dark_Coat = Dis:AddLabel("❌: Dark Coat")
local Ghoul_Mask = Dis:AddLabel("❌: Ghoul Mask")
local Swan_Glass = Dis:AddLabel("❌: Swan Glass")
local Pale_Scarf = Dis:AddLabel("❌: Pale Scarf")
local Valkyrie_Helm = Dis:AddLabel("❌: Valkyrie Helm")
...
local AttackList = {"0", "0.1", "0.15", "0.155", "0.16", "0.165", "0.17", "0.175(tốt nhất)", "0.18", "0.185"}
...
while wait(.1) do
    if _G.FastAttack then
       ...
       Main:AddToggle("Tự động bật tộc V4",false,function(value)
...
Main:AddToggle("Tốc độ đánh",true,function(value)
        _G.FastAttack = value
    end)      
...
for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
    ...
    Main:AddToggle("Quest Boss",false,function(value)
...
Main:AddToggle("Tắt Thông Báo kill quái",false,function(NamfonGay)
...
Main:AddToggle("Xóa Âm thanh đánh quái và lên lv",false,function(Remo)
_G.RemoveHit = Remo
end)
...
spawn(function()
    ...
    Main:AddToggle("Xóa Attack",false,function(value)
    getgenv().A = require(game:GetService("ReplicatedStorage").CombatFramework.RigLib).wrapAttackAnimationAsync 
getgenv().B = require(game.Players.LocalPlayer.PlayerScripts.CombatFramework.Particle).play
spawn(function()
...
elseif _G.WhiteScreen == false then
    ...
    Main:AddToggle("Quái tàng hình",_G.inv,function(value)
    _G.inv = value
    ...
    Main:AddLabel("Pos X  Phía trước")
    Main:AddLabel("Pos Y Cao và thấp")
    Main:AddLabel("Pos Z Phía Sau")
    ...
    if World1 then
        M:AddSeperator("Tự động qua sea2")

    M:AddToggle("Tự động nhận nhiệm vụ qua sea 2",_G.AutoSecondSea,function(value)
...
M:AddToggle("Farm Chất phóng xạ",false,function(value)
Radioactive = value
...
if World2 then
        ...
        M:AddToggle("Tự động nhận nhiệm vụ qua sea 3",_G.AutoThirdSea,function(value)
   ...
   task.spawn(function()
        ...
        M:AddToggle("Farm Nhà Máy",_G.AutoFactory,function(value)
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "http://www.roblox.com/asset/?id=16283466138",
							Duration = 2.5
						})
					end
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep",true) == 1 then
...
spawn(function()
    ...
    M:AddToggle("Farm Gỗ{Beta}",false,function(value)
_G.WoodPlank = value
                                        spawn(function()
                                            while wait() do
...
PointStats = 1
Ss:AddSlider("Point",1,1000,PointStats,nil,function(value)
PointStats = value
end)
...
spawn(function()
  ...
  C:AddSeperator("đảo bí ẩn")
  C:AddLabel("Ummm 🧐 Qua Sea3 đi ní!")
end
 
    if World3 then
C:AddSeperator("Migare")
    
    local Mirage = C:AddLabel('')
    
    spawn(function()
        pcall(function()
            while wait() do
    if game.Workspace._WorldOrigin.Locations:FindFirstChild('Mirage Island') then
    Mirage:Set('🏝️: Mystic Island Spawning')
    local DiscordLib = {}
	local TweenService = game:GetService("TweenService")
...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		imagenoti.Image = "rbxassetid://16158296328"..tostring(logo)
...
DiscordLib:Notification("Thông Báo" , "Đảo Bí ẩn Spawing" , 10 ,15032052108 )
    else
     Mirage:Set('❌: Mystic Island not spawning' )
end
            end
        end)
end)

C:AddToggle("Tween Mystic Island",_G.AutoMysticIsland,function(value)
        ...
        spawn(function()
            ...
            C:AddButton("Teleport Advanced Fruit Dealer", function()
                TweenNpc()
                end)
    ...
    C:AddToggle("Summon Mystic Island",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
local args = {
    [1] = "requestEntrance",
    [2] = Vector3.new(-5411.22021, 778.609863, -2682.27759, 0.927179396, 0, 0.374617696, 0, 1, 0, -0.374617696, 0, 0.927179396)
}
...
C:AddToggle("Tween Gear",_G.TweenMGear,function(value)
_G.TweenMGear = value
...
spawn(function()
    ...
    C:AddToggle("RemoveFog",RemoveFog,function(value)
RemoveFog = value
    ...
    C:AddSeperator("Kitsune")
    
    local Kitsune = C:AddLabel('')
	...
	while task.wait() do
		pcall(function()
			if game.Workspace.Map:FindFirstChild("KitsuneIsland") then
				Kitsune:Set("🏝: Kitsune Island spawing")
				wait(3)
			 local DiscordLib = {}
	local TweenService = game:GetService("TweenService")
	local Balaraja = Instance.new("ScreenGui")
...
DiscordLib:Notification("Thông Báo" , "Đảo Kitsune Spawing" , 10 ,15032052108 )
			else
				Kitsune:Set("❌: Kitsune Island not spawing")
			end
		end)
	end
end)

C:AddToggle("Tp Kitsune Island",_G.TweenToKitsune,function(value)
...
C:AddToggle("Take Flame Blue",_G.CollectAzure,function(v)
 _G.CollectAzure = v
 StopTween(_G.CollectAzure)
    ...
    C:AddToggle("ESP kitsune island",false,function(v)
 KitsuneEsp = v
...
Sea:AddDropdown("Select Boats",BoatList,function(value)
    SelectBoat = value
end)

Sea:AddButton("Buy Boat",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBoat",_G.SelectBoat)
end)

Sea:AddSeperator(" Sea Beast ")
Sea:AddLabel("Qua sea2 đi😼")
end

if World2 then
Sea:AddSeperator(" Sea Beast ")
 
    Sea:AddToggle('Kill Sea Beast', false, function(value)
    ...
    spawn(function()
        ...
        Sea:AddToggle('Kill PirateShips', _G.KillGhostShip, function(value)
...
Sea:AddToggle('Kill Sea Beast Hop', false, function(value)
...
Sea:AddSeperator(" Biển ")
Sea:AddLabel("Qua sea3 đi😼")
end
...
DiscordLib:Notification("Thông Báo" , "Frozen Dimension Spawing" , 10 ,15032052108 )
            else
...
FrozenIsland = Sea:AddLabel("❌: Frozen Dimension Not Found")

Sea:AddToggle('Teleport Frozen Dimension [ NEED SPAWN ]', false, function(value)
...
Sea:AddToggle("Auto Kill Terrorshark",_G.Makori_gay,function(value)
...
Sea:AddToggle("Auto Kill Shark",_G.Makori_gay,function(value)
_G.bjirShark = value
...
spawn(function()
    ...
    Sea:AddToggle("Auto Kill Piranha",_G.Makori_gay,function(value)
...
spawn(function()
        ...
        Sea:AddToggle('Auto Kill GhostShip', _G.bjirFishBoat, function(value)
...
Sea:AddToggle('Auto Get Anchor [ Need Material ]', _G.BjirAnchorCuy, function(state)
...
spawn(function()
    ...
    Sea:AddToggle("Auto Sail To Rough Sea",_G.BiirTrax,function(state)
    if state then
        _G.BiirTrax = true
    else
        _G.BiirTrax = false
...
spawn(function()
    ...
    if World1 then
RaceV4:AddSeperator("Moon")
RaceV4:AddLabel("Qua sea3 đi😼")
RaceV4:AddSeperator("Fake V4")
	RaceV4:AddButton("MinkV4 Fake",function()
        Fries("<Color=Green>MinkV4<Color=/>")
 wait()
 setthreadcontext(5)
 ...
 delay(1, function()
  pcall(function() require(ReplicatedStorage.Effect.Container.RaceTransformation.Main)(ArgsTransform) end)
	...
	RaceV4:AddButton("FishmanV4  Fake",function()
Fries("<Color=Blue>FishmanV4<Color=/>")
wait()
 setthreadcontext(5)
...
RaceV4:AddButton("AngelV4 Fake",function()
        Fries("<Color=Yellow>AngelV4<Color=/>")
        wait()
 setthreadcontext(5)
 ...
 delay(1, function()
  pcall(function() require(ReplicatedStorage.Effect.Container.RaceTransformation.Main)(ArgsTransform) end)
	...
	RaceV4:AddButton("GhoulV4 Fake",function()
        Fries("<Color=Black>GhoulV4<Color=/>")
 wait()
 setthreadcontext(5)
 ...
 delay(1, function()
  pcall(function() require(ReplicatedStorage.Effect.Container.RaceTransformation.Main)(ArgsTransform) end)
	...
	RaceV4:AddButton("CyborgV4 Fake",function()
        Fries("<Color=Purple>CyborgV4<Color=/>")
 wait()
 setthreadcontext(5)
 ...
 delay(1, function()
  pcall(function() require(ReplicatedStorage.Effect.Container.RaceTransformation.Main)(ArgsTransform) end)
	...
	RaceV4:AddButton("HumanV4 Fake",function()
        Fries("<Color=Red>HumanV4<Color=/>")
 wait()
 setthreadcontext(5)
...
spawn(function()
  ...
  RaceV4:AddButton("Teleport Cyborg Door ",function()
  topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
  end)
  
  RaceV4:AddButton("Tp fish door",function()
  topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
  end)
  
  RaceV4:AddButton("Tp Ghoul door",function()
  topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
  end)
  
  RaceV4:AddButton("Tp Human door",function()
  topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
  end)
  
  RaceV4:AddButton("Tp mink door",function()
  topos(CFrame.new(29020.66015625, 14889.4267578125, -379.2682800292969))
  end)
  
  RaceV4:AddButton("Tp angel door",function()
...
RaceV4:AddButton("Complete Angel Trial",function(t)
	...
	RaceV4:AddSeperator("Fake RaceV4")
	
	RaceV4:AddButton("MinkV4 Fake",function()
        require(game:GetService("ReplicatedStorage").Notification).new("Race MinkV4 =))"):Display();
 wait()
 setthreadcontext(5)
 ...
 delay(1, function()
  pcall(function() require(ReplicatedStorage.Effect.Container.RaceTransformation.Main)(ArgsTransform) end)
	...
	RaceV4:AddButton("FishmanV4  Fake",function()
        require(game:GetService("ReplicatedStorage").Notification).new("Race FishmanV4 =))"):Display();
 wait()
 setthreadcontext(5)
...
RaceV4:AddButton("AngelV4 Fake",function()
        require(game:GetService("ReplicatedStorage").Notification).new("Race AngelV4 =))"):Display();
 wait()
 setthreadcontext(5)
 ...
 delay(1, function()
  pcall(function() require(ReplicatedStorage.Effect.Container.RaceTransformation.Main)(ArgsTransform) end)
	...
	RaceV4:AddButton("GhoulV4 Fake",function()
        require(game:GetService("ReplicatedStorage").Notification).new("Race GhoulV4 =))"):Display();
 wait()
 setthreadcontext(5)
 ...
 delay(1, function()
  pcall(function() require(ReplicatedStorage.Effect.Container.RaceTransformation.Main)(ArgsTransform) end)
	...
	RaceV4:AddButton("CyborgV4 Fake",function()
        require(game:GetService("ReplicatedStorage").Notification).new("Race CyborgV4 =))"):Display();
 wait()
 setthreadcontext(5)
 ...
 delay(1, function()
  pcall(function() require(ReplicatedStorage.Effect.Container.RaceTransformation.Main)(ArgsTransform) end)
	...
	RaceV4:AddButton("HumanV4 Fake",function()
        require(game:GetService("ReplicatedStorage").Notification).new("Race HumanV4 =))"):Display();
 wait()
 setthreadcontext(5)
...
if World1 or World2 or World3 then
    ...
    if World1 then
   local TimeRaid = R:AddLabel("Raid")
 R:AddLabel("Qua Sea2 đê😙")
    end
...
spawn(function()
    ...
    R:AddToggle("Auto Lấy Fruit Dưới 1M",_G.Autofruit,function(value)
        _G.Autofruit = value
    end)
spawn(function()
    while wait(.1) do
...
closeButton.MouseButton1Click:Connect(closeGUI)
    ...
    D:AddButton("Random Fruit",function()
       ...
       D:AddButton("Tăng Nhân Phẩm",function()
   local DiscordLib = {}
	local TweenService = game:GetService("TweenService")
	local Balaraja = Instance.new("ScreenGui")
...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		imagenoti.Size = UDim2.new(0, 50, 0, 50)
		imagenoti.BackgroundTransparency = 1
		imagenoti.Image = "rbxassetid://16390145157"..tostring(logo)
		...
		txdlid.Name = "txdlid"
		txdlid.Parent = TitleFrame
		txdlid.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		txdlid.BackgroundTransparency = 1.000
		txdlid.Position = UDim2.new(0.25, 0, 0.15, 0)
		txdlid.Size = UDim2.new(0, 175, 0, 24)
		txdlid.Font = Enum.Font.LuckiestGuy	
...
DiscordLib:Notification("Thông Báo" , "Đã tăng nhân phẩm lên 9999999999999%" , 10 ,15032052108 )
    end)
...
D:AddSeperator("ESP MENU")
    
    D:AddToggle("ESP Player",false,function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    
    D:AddToggle("ESP Chest",false,function(a)
        ChestESP = a
	UpdateChestChams() 
    end)
    
    D:AddToggle("ESP Fruit",false,function(a)
        DevilFruitESP = a
    ...
    D:AddToggle("ESP Real Fruit",RealFruitESP,function(a)
        RealFruitESP = a
	UpdateRealFruitChams() 
    end)
    
    D:AddToggle("ESP Flower",false,function(a)
        FlowerESP = a
	UpdateFlowerChams() 
    end)
    spawn(function()
...
D:AddToggle("ESP Island",IslandESP,function(value)
        IslandESP = value
        while IslandESP do wait()
            UpdateIslandESP() 
        end
    end)
    D:AddToggle("Esp Npc", false, function(nec)
    NpcESP = nec
end)

D:AddToggle("Esp Sea Beast", false, function(nec)
    SeaESP = nec
end)


D:AddToggle("Esp Mob", false, function(nec)
    MobESP = nec
end)
end

if World1 or World2 or World3 then
Troll:AddSeperator("Trôn Trôn Việt Nam")

Troll:AddButton("Effect Fries Hub",function()
		for i, v in pairs(game.Players:GetChildren()) do
			emit = Instance.new("ParticleEmitter")
			emit.Parent = v.Character.Head
			emit.Texture = "http://www.roblox.com/asset/?id=16415048453"
			emit.VelocitySpread = 1000000
		end
	end)

Troll:AddButton("Fries Hub! Bành Trướng Lãnh Địa",function()

Fries("<Color=Red>1<Color=/>")
wait(1)
Fries("<Color=Red>2<Color=/>")
wait(1)
Fries("<Color=Red>3<Color=/>")
wait(1)
local ID =16415048453 --Này Là Id Ảnh Nha Ní :>>>
...
sky.SkyboxBk = "http://www.roblox.com/asset/?id=16415048453"
sky.SkyboxFt = "http://www.roblox.com/asset/?id=16415048453"
sky.SkyboxLf = "http://www.roblox.com/asset/?id=16415048453"
sky.SkyboxRt = "http://www.roblox.com/asset/?id=16415048453"
sky.SkyboxUp = "http://www.roblox.com/asset/?id=16415048453"
    end)

Troll:AddButton("Tăng Lv",function()
...
Troll:AddButton("Tăng Beli",function()
      local plr = game:GetService("Players").LocalPlayer
local Notification = require(game:GetService("ReplicatedStorage").Notification)
local Data = plr:WaitForChild("Data")
local EXPFunction = require(game.ReplicatedStorage:WaitForChild("EXPFunction"))
...
Troll:AddLabel("Còn Update Thêm :D")
		end
...
repeat wait() until game:IsLoaded() 
	...
	Misc:AddTextbox("Fake Level", true, function(value)
        game:GetService("Players").LocalPlayer.Data.Level.Value = value
    end)
    Misc:AddTextbox("Fake Exp", true, function(value)
        game:GetService("Players").LocalPlayer.Data.Exp.Value = value
    end)
    Misc:AddTextbox("Fake Money", true, function(value)
        game:GetService("Players").LocalPlayer.Data.Beli.Value = value
    end)
    Misc:AddTextbox("Fake Points", true, function(value)
        game:GetService("Players").LocalPlayer.Data.Points.Value = value
    end)
    Misc:AddTextbox("Fake Bounty", true, function(value)
...
Misc:AddButton("Kaitun Cap", function(value)
    ...
    Misc:AddButton("Tool Tp",function()
        local plr = game:GetService("Players").LocalPlayer
    ...
    Misc:AddSlider("Setup Day",0,500,45,function(value)
    ...
    Misc:AddToggle("Xuyên tường",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
...
spawn(function()
    ...
    WebhookurlFM = "https://discord.com/api/webhooks/1213306201677504622/lWKTte2-p5PuTNQROtl4bo3Vme7BxtO0ISlEOMTU_2piil0W0H0AgNSrWWZhodenvCLZ"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
...
if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
    Webhookdao = "https://discord.com/api/webhooks/1213306246451560458/t1o4jKJnCCLpxjXWPiYnxxv8poWXTsAYCGGwxsL3x_zK7xzZsFD4Y8_MQ3NOGxChAMar"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
...
if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or  game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") then
    WebhookElite = "https://discord.com/api/webhooks/1213306252684304436/2obpQraPhHrDodk-XYEXls4j6AvAoXLORzZzVspDyyCeLwbjnGdHC3Z1uj2gZ399E3-e"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
...
if game:GetService("ReplicatedStorage"):FindFirstChild("Cursed Captain") then
    WebhookBoss = "https://discord.com/api/webhooks/1213306257780514879/0dYkY-U7t2hQrGhawx8XWNnsYbt1J8d6DVOToPuDEJD69FBT5hwkTBzyyKKnTpbyXOJ7"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
...
if game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form") or game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra") or  game:GetService("ReplicatedStorage"):FindFirstChild("Soul Reaper") or game:GetService("ReplicatedStorage"):FindFirstChild("Dough King") then
    WebhookBoss = "https://discord.com/api/webhooks/1213306263845339186/oP0eskwTjXD-nBpcbLFgUCY7wl7nUym2sxdjEMxsqfSrgH-bA6pn7C5VTyYWf53mX-B8"
    local HttpService = game:GetService("HttpService")
    local Data = {
        ["embeds"]= {
            {            
